...
namespace TurkcellBank.Infrastructure.Migrations
{
    ...
    [Migration("20260701072607_AddCreditCards")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.BillPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BillerCode", "SubscriberNo", "Period")
                        .IsUnique();
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.Card", b =>
                {
                    ...
                    b.Property<bool>("OnlineShoppingEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.CreditCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "NextStatementDate");

                    b.ToTable("CreditCards");
                });

            modelBuilder.Entity("TurkcellBank.Domain.Entities.CreditCardInstallmentPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("InstallmentsBilled")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CreditCardInstallmentPlans");
                });

            modelBuilder.Entity("TurkcellBank.Domain.Entities.CreditCardStatement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.ExchangeRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal>("BaseMid")
                        .HasPrecision(18, 4)
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.FxConversion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.FxRateAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FxRateAlerts");
                });

            modelBuilder.Entity("TurkcellBank.Domain.Entities.FxTrade", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ForeignAccountId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.PaymentOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TurkcellBank.Domain.Entities.TimeDeposit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
